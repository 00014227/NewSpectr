...
export default function Web() {
    ...
    return (
        ...
        className='lg:flex block bg-black lg:overflow-x-hidden overflow-x-hidden lg:overflow-y-hidden items-center  h-[100vh]'>
            <NavBar navbar={navbar}/>
            <section className='bg-black flex-shrink-0  w-auto lg:h-[100vh] md:h-[80vh]  flex items-center px-11'>
            ...
            <section className='bg-black flex-shrink-0  w-auto lg:h-screen h-auto block lg:flex items-center  lg:px-11 pr-11'>
                ...
                <div className=' 2xl:max-w-[2688px] lg:ml-24 px-10 relative'>
                    ...
                    <p className="2xl:w-[600px] md:absolute lg:top-9 lg:right-[-300px] top-[280px] right-0 w-[350px] text-white text-[18px] 2xl:text-[28px] font-normal font-['Evolventa'] capitalize leading-[42px]">
                    Рисуем прототипы, создаём макеты, верстаем для разных типов устройств. Внедряем необходимую CMS, интегрируем CRM.</p>
                </div>
                <div className='lg:block md:block hidden lg:ml-40'>
                    <SnakeBox />
                </div>


                <div className='lg:block md:flex justify-center items-center md:mt-0 mt-9 md:ml-28 '>
            ...
            <section className='bg-black flex-shrink-0  w-auto  h-screen  lg:flex items-center'>
                ...
                <div className=' 2xl:max-w-[2688px] lg:ml-24 px-10 relative'>
                    ...
                    <p className="2xl:w-[600px] lg:w-[540px] w-[400px] lg:absolute top-[-45px] 2xl:right-[-350px] lg:right-[-370px] right-[20px]  text-white text-[18px] 2xl:text-[28px] font-normal font-['Evolventa'] capitalize leading-[42px]">
