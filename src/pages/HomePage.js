...
const HomePage = () => {
    ...
    return (
        ...
        <div ref={scrollContainerRef} onWheel={handleWheelScroll}
            ...
            <section className='flex-shrink-0  w-auto lg:h-screen lg:flex items-center justify-center md:pr-10 pb-10'>
                ...
                {/* Cards */}
                <div className=' grid px-4 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 space-y-4 space-x-4'>
                    {/* <SwiperHome /> */}
                    {isMobile ? (
                        <SLick />
                    ) : (
            ...
            <section className='flex-shrink-0  w-auto 2xl:h-screen h-auto  lg:flex  lg:items-center justify-center lg:pt-0  md:pt-32 pb-9'>
                ...
                <div className=' grid px-4 grid-cols-3 space-y-4 space-x-4'>
